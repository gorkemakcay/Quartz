        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MemberOf = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PipeOd = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PipeThickness = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OperatingTemp = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OperatingPressute = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TagName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShowLabel = table.Column<bool>(type: "bit", nullable: false),
                    SelectDrawing = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Quartzes", x => x.Id);
                });
